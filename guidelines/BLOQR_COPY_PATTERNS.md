...
> that contradict the voice rules in `guidelines/BLOQR_BRAND_HANDOFF.md`.
>
> For full voice/tone rules, see `guidelines/BLOQR_BRAND_HANDOFF.md §10` and `guidelines/BLOQR_DESIGN_LANGUAGE.md`.
